...
?>
	<form method="get" name="searchForm" id="searchForm" class="searchTop"  action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search">
      <input type="search" name="s" placeholder="Search muthetaatlarge.com" value="<?php echo esc_attr( get_search_query() ); ?>" id="s" placeholder="<?php echo esc_attr_x( 'Search &hellip;', 'placeholder', '_s' ); ?>" >
